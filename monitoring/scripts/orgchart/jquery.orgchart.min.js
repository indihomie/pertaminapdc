...
(function($) {
    ...
    function buildNode($node, $appendTo, level, index, opts) {
        var $table = $("<table id='xxx' cellpadding='0' cellspacing='0' border='0'/>");
        var $tbody = $("<tbody/>");
        ...
        $nodeDiv.click(function() {
            $this = $(this);
			dta = $this.html();
			arr = dta.split('<label style="display:none">');
			kodeData = arr[1].replace('</label></h2>','');
			levelData = parseInt(level + 1);
			getPar = $('#_par').val();
			
			openBox('popup.php?par[mode]=det&par[kodeData]=' + kodeData + '&par[levelData]=' + levelData + getPar + '#loaded',900,525);
