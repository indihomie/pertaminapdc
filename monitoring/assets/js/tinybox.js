...
tiny.box = function () {
    ...
    return {
        show: function (o) {
            v = {opacity: 70, close: 1, animate: 1, fixed: 1, mask: 1, maskid: '', boxid: '', topsplit: 2, url: 0, post: 0, height: 0, width: 0, html: 0, iframe: 0, isCancellable: true};
            for (s in o) {
                v[s] = o[s]
            }
            if (!p) {
            ...
            if (v.autohide) {
                ...
                document.onkeyup = v.isCancellable ? tiny.box.esc : null
            }
        },
