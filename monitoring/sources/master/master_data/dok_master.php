...
function hapus(){
	...
	$sql = "DELETE FROM mst_data WHERE kodeCategory = '$par[kodeCategory]'";
	db($sql);
		...
		<form action=\"\" method=\"post\" class=\"stdform\">
			<div id=\"pos_l\" style=\"float:left;\">
				<p>
					...
					if(!empty($namaCategory))
						$text.=" ".comboData("select * from mst_data where kodeCategory='$kodeCategory' and statusData='t' order by namaData","kodeData","namaData","par[kodeInduk]","All",$par[kodeInduk],"", "200px", "chosen-select");
					...
					<table cellpadding=\"0\" cellspacing=\"0\" border=\"0\" class=\"stdtable stdtablequick\" id=\"dyntable\">
						<thead>
							...
							<tbody>";
								...
								$sql="select t1.*,t2.iconMenu from mst_category t1 join app_menu t2 on (t1.kodeMenu=t2.kodeMenu) $filter order by t1.urutanCategory ";
								//echo $sql;
								...
								while($r=mysql_fetch_array($res)){			
									...
									"<img src=\"styles/images/t.png\" title='Active'>":
									"<img src=\"styles/images/f.png\" title='Not Active'>";
									$icons = empty($r[iconMenu]) ? "styles/images/paper.png" : "images/menu/".$r[iconMenu];

									$text.="<tr>
									<td>$no.</td>
									<td align=\"center\" valign='center'>
										<img src=\"".$icons."\" align=\"left\" height=\"25\" style=\"padding-right:5px; padding-bottom:5px;\">
									</td>
									...
									<td>";
										...
										"$r[namaCategory]";
										$text.="</td>
    									<td>".getField("SELECT COUNT(kodeData) FROM mst_data WHERE kodeCategory = '$r[kodeCategory]'")."</td>
