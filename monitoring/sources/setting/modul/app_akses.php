				  ...
				  if ($cntMenu[$kodeMenu1] > 0 || $cUsername == $sUser){
					  ...
					  if (is_array($arrMenu[$kodeMenu1])) {
						...
						while (list($kMenu2, $vMenu2) = each($arrMenu[$kodeMenu1])) {
						  ...
						  #MAZTE-ADD
						  if (strlen($aksesMenu2 > 4)) {
							$aksesAppr1 = substr($aksesMenu2, 4, 1);
							$aksesAppr2 = substr($aksesMenu2, 5, 1);
							$aksesAppr3 = substr($aksesMenu2, 6, 1);
						  }
						  #END-MAZTE ADD
						  ...
						  #MAZTE-ADD
						  if (strlen($aksesMenu2 > 4)) {
							$appr1 = $arrGroup[$kodeMenu2]["apprlv1"] ? "checked=\"checked\"" : "";
							$appr2 = $arrGroup[$kodeMenu2]["apprlv2"] ? "checked=\"checked\"" : "";
							$appr3 = $arrGroup[$kodeMenu2]["apprlv3"] ? "checked=\"checked\"" : "";
						  }
						  #END MAZTE-ADD
						  ...
						  if (!empty($kodeTarget2)) {
							...
							#MAZTE-ADD
							if ($aksesAppr1)
							  $text.="<td style=\"padding:5px;border-bottom:1px solid #ecebeb;\" width=\"100\"><input type=\"checkbox\" id=\"group[apprlv1][$kodeMenu2]\" name=\"group[apprlv1][$kodeMenu2]\" value=\"$kodeMenu2\" $appr1 /> Approval Lv1</td>";
							if ($aksesAppr2)
							  $text.="<td style=\"padding:5px;border-bottom:1px solid #ecebeb;\" width=\"100\"><input type=\"checkbox\" id=\"group[apprlv2][$kodeMenu2]\" name=\"group[apprlv2][$kodeMenu2]\" value=\"$kodeMenu2\" $appr2 /> Approval Lv2</td>";
							if ($aksesAppr3)
							  $text.="<td style=\"padding:5px;border-bottom:1px solid #ecebeb;\" width=\"100\"><input type=\"checkbox\" id=\"group[apprlv3][$kodeMenu2]\" name=\"group[apprlv3][$kodeMenu2]\" value=\"$kodeMenu2\" $appr3 /> Approval Lv3</td>";
							#END MAZTE-ADD
						  }
						  $text.="</tr>";
						  
							if (is_array($arrMenu[$kodeMenu2])) {
								asort($arrMenu[$kodeMenu2]);
								reset($arrMenu[$kodeMenu2]);
								while (list($kMenu3, $vMenu3) = each($arrMenu[$kodeMenu2])) {
								  list($urutanMenu3, $kodeMenu3, $namaMenu3, $iconMenu3, $kodeTarget3, $aksesMenu3) = explode("\t", $vMenu3);

								  $aksesView3 = substr($aksesMenu3, 0, 1);
								  $aksesAdd3 = substr($aksesMenu3, 1, 1);
								  $aksesEdit3 = substr($aksesMenu3, 2, 1);
								  $aksesDelete3 = substr($aksesMenu3, 3, 1);
									
								  #MAZTE-ADD
								  if (strlen($aksesMenu3 > 4)) {
									$aksesAppr1 = substr($aksesMenu3, 4, 1);
									$aksesAppr2 = substr($aksesMenu3, 5, 1);
									$aksesAppr3 = substr($aksesMenu3, 6, 1);
								  }
								  #END-MAZTE ADD
								
								  $view3 = $arrGroup[$kodeMenu3]["view"] ? "checked=\"checked\"" : "";
								  $add3 = $arrGroup[$kodeMenu3]["add"] ? "checked=\"checked\"" : "";
								  $edit3 = $arrGroup[$kodeMenu3]["edit"] ? "checked=\"checked\"" : "";
								  $delete3 = $arrGroup[$kodeMenu3]["delete"] ? "checked=\"checked\"" : "";

								  #MAZTE-ADD
								  if (strlen($aksesMenu3 > 4)) {
									$appr1 = $arrGroup[$kodeMenu3]["apprlv1"] ? "checked=\"checked\"" : "";
									$appr2 = $arrGroup[$kodeMenu3]["apprlv2"] ? "checked=\"checked\"" : "";
									$appr3 = $arrGroup[$kodeMenu3]["apprlv3"] ? "checked=\"checked\"" : "";
								  }
								  #END MAZTE-ADD
								  
								  if ($cntMenu[$kodeMenu3] > 0 || $cUsername == $sUser){
								  $text.= "<tr>
											<td style=\"padding-left:75px; padding-top:5px; padding-bottom:5px;border-bottom:1px solid #ecebeb;\">&middot; $namaMenu3</td>";
								  if (!empty($kodeTarget3)) {
									if ($aksesView3)
									  $text.="<td style=\"padding:5px;border-bottom:1px solid #ecebeb;\" width=\"75\"><input type=\"checkbox\" id=\"group[view][$kodeMenu3]\" name=\"group[view][$kodeMenu3]\" value=\"$kodeMenu3\" $view3 /> View</td>";
									if ($aksesAdd3)
									  $text.="<td style=\"padding:5px;border-bottom:1px solid #ecebeb;\" width=\"75\"><input type=\"checkbox\" id=\"group[add][$kodeMenu3]\" name=\"group[add][$kodeMenu3]\" value=\"$kodeMenu3\" $add3 /> Add</td>";
									if ($aksesEdit3)
									  $text.="<td style=\"padding:5px;border-bottom:1px solid #ecebeb;\" width=\"75\"><input type=\"checkbox\" id=\"group[edit][$kodeMenu3]\" name=\"group[edit][$kodeMenu3]\" value=\"$kodeMenu3\" $edit3 /> Edit</td>";
									if ($aksesDelete3)
									  $text.="<td style=\"padding:5px;border-bottom:1px solid #ecebeb;\" width=\"100\"><input type=\"checkbox\" id=\"group[delete][$kodeMenu3]\" name=\"group[delete][$kodeMenu3]\" value=\"$kodeMenu3\" $delete3 /> Delete</td>";						  
									#MAZTE-ADD
									if ($aksesAppr1)
									  $text.="<td style=\"padding:5px;border-bottom:1px solid #ecebeb;\" width=\"100\"><input type=\"checkbox\" id=\"group[apprlv1][$kodeMenu3]\" name=\"group[apprlv1][$kodeMenu3]\" value=\"$kodeMenu3\" $appr1 /> Approval Lv1</td>";
									if ($aksesAppr2)
									  $text.="<td style=\"padding:5px;border-bottom:1px solid #ecebeb;\" width=\"100\"><input type=\"checkbox\" id=\"group[apprlv2][$kodeMenu3]\" name=\"group[apprlv2][$kodeMenu3]\" value=\"$kodeMenu3\" $appr2 /> Approval Lv2</td>";
									if ($aksesAppr3)
									  $text.="<td style=\"padding:5px;border-bottom:1px solid #ecebeb;\" width=\"100\"><input type=\"checkbox\" id=\"group[apprlv3][$kodeMenu3]\" name=\"group[apprlv3][$kodeMenu3]\" value=\"$kodeMenu3\" $appr3 /> Approval Lv3</td>";
									#END MAZTE-ADD
								  }
								  $text.="</tr>";
								  }
  ...
  $text.="<div class=\"pageheader\">
			...
			<thead>
				<tr>
					...
					<th>Nama</th>
					<th>Deskripsi</th>
					<th width=\"50\">Status</th><th width=\"50\">Kontrol</th>";
  $text.="</tr>
			</thead>
			<tbody>";
