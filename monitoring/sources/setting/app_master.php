		...
		<form action=\"\" method=\"post\" class=\"stdform\">
			<div id=\"pos_l\" style=\"float:left;\">
				<p>
					...
					if(!empty($kodeCategory))
						$text.=" ".comboData("select * from mst_data where kodeCategory='$kodeCategory' and statusData='t' order by namaData","kodeData","namaData","par[kodeInduk]","All",$par[kodeInduk],"", "250px");
			...
			<div id=\"contentwrapper\" class=\"contentwrapper\">			
				...
				<table cellpadding=\"0\" cellspacing=\"0\" border=\"0\" class=\"stdtable stdtablequick\" id=\"dyntable\">
					...
					<div id=\"contentwrapper\" class=\"contentwrapper\">											
						...
						<div class=\"logincontent\" style='margin-top:20px;'>
							<ul class=\"shortcuts\">";	
