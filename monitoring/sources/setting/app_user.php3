<?php
	...
	$pengacak2 = "8eb98b33c777a27ab57a35ee1dc3a389";
		...
		$sql="insert into app_user (username, kodeGroup,jenisUser, idPegawai, password, namaUser, keteranganUser,hp,email, fotoUser, statusUser, createBy, createTime) values ('$inp[username]', '$inp[kodeGroup]','0', '$inp[idPegawai]', '".$password."', '$inp[namaUser]', '$inp[keteranganUser]', '$inp[hp]','$inp[email]','$fotoUser', '$inp[statusUser]', '$cUsername', '".date('Y-m-d H:i:s')."')";
		db($sql);
